...
def test_remove_command_with_non_existing_study(db):
...
def test_remove_command_aborts(study, mocked_delete_method):
...
def test_remove_command_removes_study(study, mocked_delete_method):
...
def test_remove_command_force_removes_study(option, study, mocked_delete_method):
