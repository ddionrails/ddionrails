...
def test_attachment_admin_list(admin_client, attachment):  #pylint: disable=unused-argument
...
def test_publication_admin_list(admin_client, publication):  #pylint: disable=unused-argument
