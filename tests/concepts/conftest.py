...
def concept(db):
    ...
    return ConceptFactory(name="some-concept", label="Some Concept", description="This is some concept")
...
def analysis_unit(db):
    ...
    return AnalysisUnitFactory(
        name="some-analysis-unit", label="Some analysis unit", description="This is some analysis unit"
    )
...
def conceptual_dataset(db):
    ...
    return ConceptualDatasetFactory(
        name="some-conceptual-dataset", label="Some conceptual dataset", description="This is some conceptualdataset"
    )
...
def period(db):
    ...
    return PeriodFactory(name="some-period", label="Some period", description="This is some period", definition="2018")
...
def period_with_range_definition(db):
    ...
    return PeriodFactory(name="some-period", description="This is some period", definition="2010-01:2018-12")


@pytest.fixture
def valid_concept_data():
    """ A valid input for concept forms and imports """
    return dict(concept_name="some-concept", label="Some Concept", description="This is some concept")
...
def valid_analysis_unit_data():
    ...
    return dict(
        analysis_unit_name="some-analysis-unit", label="Some Analysis unit", description="This is some analysis unit"
    )
