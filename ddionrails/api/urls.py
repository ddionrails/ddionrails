...
urlpatterns = [
    ...
    path(
        (
            "topics/<str:study_name>/<str:language>/"
            "concept_<str:concept_name>/add_to_basket/<int:basket_id>"
        ),
    ...
    path(
        (
            "topics/<str:study_name>/<str:language>/"
            "topic_<str:topic_name>/add_to_basket/<int:basket_id>"
        ),
    ...
    path(
        (
            "topics/<str:study_name>/<str:language>/"
            "variable_<uuid:variable_id>/add_to_basket/<int:basket_id>"
        ),
